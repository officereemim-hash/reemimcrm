...
import { ChevronLeft, ChevronRight, X, List, Zap } from 'lucide-react';
import { motion } from 'framer-motion';
import TutorialProgress from './TutorialProgress';

export default function TutorialCard({ step, currentStep, totalSteps, steps, onNext, onPrev, onClose, onGoToStep }) {
  ...
  return (
    <motion.div
      ...
      className={`bg-gradient-to-br ${step.bgColor || 'from-white to-gray-50'} border border-border rounded-2xl shadow-2xl p-5 w-[400px] max-w-[92vw]`}
      style={{ direction: 'rtl' }}
    >
      {/* Header */}
      ...
      {/* Bot flows list */}
      {step.flows && (
        <div className="mb-3 bg-white/60 rounded-xl p-3 space-y-2 max-h-[200px] overflow-y-auto">
          {step.flows.map((f) => (
