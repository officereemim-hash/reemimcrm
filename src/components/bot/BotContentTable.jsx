...
export default function BotContentTable({ items, onEdit, onDelete }) {
  return (
    <div className="border rounded-lg overflow-hidden">
      <Table>
        ...
        <TableBody>
          {items.length === 0 ? (
            <TableRow><TableCell colSpan={6} className="text-center py-8 text-muted-foreground">אין הודעות</TableCell></TableRow>
          ) : items.map(item => (
